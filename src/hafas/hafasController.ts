...
import { Stop, Location, Station, Journeys, Alternative, Trip } from './hafas-client-types';
...
export class HafasController extends Controller {
  ...
  */
  ...
  public async gettrip(
    ...
    const client = this.clientFactory();
    return await client.trip(id, name, { stopovers, polyline, subStops, entrances, remarks, language }) as Trip;
  }
  /**
  ...
  */
  ...
  public async getnearby(
    ...
    const client = this.clientFactory();
    return await client.nearby({ type: "location", longitude, latitude }, { results, distance, poi, stops, subStops, entrances, linesOfStops, language }) as Array<Stop>;
  }
  // endOfRange
}