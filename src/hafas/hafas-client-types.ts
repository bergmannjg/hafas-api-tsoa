...
export interface Station {
    ...
    stops?: Array<Station | Stop | Location>;
    entrances?: Array<Location>;
...
export interface Warning {
    ...
    categories?: number[];
    affectedLines?: Line[];
    fromStops?: Array<Station | Stop | Location>;
    toStops?: Array<Station | Stop | Location>;
}
...
export interface StopOver {
    ...
    remarks?: Array<Hint | Status | Warning>;
    passBy?: boolean;
    cancelled?: boolean;
...
export interface Alternative {
    ...
    loadFactor?: string;
    provenance?: string;
    previousStopovers?: Array<StopOver>;
...
export interface Duration {
    duration: number;
    stations: Array<Station | Stop | Location>;
}
...
export interface HafasClient {
     ...
     * @param options options for search
     */
    nearby: (location: Location, options: NearByOptions | undefined) => Promise<Array<Station | Stop | Location>>;
    /**
